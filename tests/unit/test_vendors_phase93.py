...
def test_phase93_tenant_isolation(client, db_session):
    ...
    # matching every other entity's cross-tenant check -- indistinguishable from a
    # vendor_id that doesn't exist anywhere, so the status code can't be used to confirm
