"""guardrail policy assignment mappings

Revision ID: 0046_guardrail_policy_assignments
Revises: 0045_guardrail_policy_sets
...
revision: str = "0046_guardrail_policy_assignments"
down_revision: str | None = "0045_guardrail_policy_sets"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_ai_sys_gov_guardrail_policy_assign_org_status",
        "ai_system_governance_guardrail_policy_assignments",
        ["organization_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_guardrail_policy_assign_org_scope",
        "ai_system_governance_guardrail_policy_assignments",
        ["organization_id", "scope_type"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_guardrail_policy_assign_org_policy",
        "ai_system_governance_guardrail_policy_assignments",
        ["organization_id", "policy_set_id"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_guardrail_policy_assign_org_priority",
        "ai_system_governance_guardrail_policy_assignments",
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["assignment_id"], ["ai_system_governance_guardrail_policy_assignments.id"], ondelete="CASCADE"),
    ...
    op.create_index(
        "ix_ai_sys_gov_guardrail_policy_assign_hist_org_assignment",
        "ai_system_governance_guardrail_policy_assignment_history",
        ["organization_id", "assignment_id"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_guardrail_policy_assign_hist_org_created",
        "ai_system_governance_guardrail_policy_assignment_history",
