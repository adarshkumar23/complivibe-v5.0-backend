"""diagnostic export diff gating profiles and reports

Revision ID: 0060_diagnostic_export_diff_gating
Revises: 0059_export_diff_reason_code_fields
...
revision: str = "0060_diagnostic_export_diff_gating"
down_revision: str | None = "0059_export_diff_reason_code_fields"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_profiles_org_status",
        "ai_system_governance_diagnostic_export_diff_gating_profiles",
        ["organization_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_profiles_org_created",
        "ai_system_governance_diagnostic_export_diff_gating_profiles",
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("export_diff_report_id", postgresql.UUID(as_uuid=True), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["gating_profile_id"],
            ["ai_system_governance_diagnostic_export_diff_gating_profiles.id"],
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(["created_by_user_id"], ["users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["archived_by_user_id"], ["users.id"], ondelete="SET NULL"),
    ...
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_reports_org_status",
        "ai_system_governance_diagnostic_export_diff_gating_reports",
        ["organization_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_reports_org_created",
        "ai_system_governance_diagnostic_export_diff_gating_reports",
        ["organization_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_reports_org_diff",
        "ai_system_governance_diagnostic_export_diff_gating_reports",
        ["organization_id", "export_diff_report_id"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_reports_org_profile",
        "ai_system_governance_diagnostic_export_diff_gating_reports",
        ["organization_id", "gating_profile_id"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_reports_org_review_req",
        "ai_system_governance_diagnostic_export_diff_gating_reports",
        ["organization_id", "review_required"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_diag_export_diff_gating_reports_org_max_severity",
        "ai_system_governance_diagnostic_export_diff_gating_reports",
