"""hipaa obligation pack seed

Revision ID: 0154_hipaa_obligation_pack_seed
Revises: 0153_hipaa_schema_extensions
...
from app.services.framework_seed_data_stream_a4 import HIPAA_NIST_MAPPINGS, HIPAA_OBLIGATIONS, HIPAA_QUESTIONS, HIPAA_SECTIONS

revision: str = "0154_hipaa_obligation_pack_seed"
down_revision: str | None = "0153_hipaa_schema_extensions"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

HIPAA_FRAMEWORK_NAME = "HIPAA"


def _seed_hipaa(bind: sa.Connection) -> None:
    frameworks = sa.table(
        "frameworks",
    ...
    framework_id = bind.execute(sa.select(frameworks.c.id).where(frameworks.c.name == HIPAA_FRAMEWORK_NAME)).scalar_one_or_none()
