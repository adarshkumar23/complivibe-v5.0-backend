"""preset assignment diagnostic reports

Revision ID: 0056_preset_assignment_diagnostic_reports
Revises: 0055_policy_diff_gating_compare_preset_assignments
...
revision: str = "0056_preset_assignment_diagnostic_reports"
down_revision: str | None = "0055_policy_diff_gating_compare_preset_assignments"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("resolved_contexts_count", sa.Integer(), nullable=False),
        sa.Column("unresolved_contexts_count", sa.Integer(), nullable=False),
        sa.Column("warning_contexts_count", sa.Integer(), nullable=False),
        sa.Column("critical_contexts_count", sa.Integer(), nullable=False),
        sa.Column("aggregate_diagnostics_json", sa.JSON(), nullable=True),
    ...
    op.create_index(
        "ix_ai_sys_gov_preset_assign_diag_reports_org_status",
        "ai_system_governance_preset_assignment_diagnostic_reports",
        ["organization_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_preset_assign_diag_reports_org_created",
        "ai_system_governance_preset_assignment_diagnostic_reports",
    ...
    op.create_table(
        ...
        sa.Column("resolved_delta", sa.Integer(), nullable=False),
        sa.Column("unresolved_delta", sa.Integer(), nullable=False),
        sa.Column("warning_delta", sa.Integer(), nullable=False),
        sa.Column("critical_delta", sa.Integer(), nullable=False),
        sa.Column("diagnostic_code_changes_count", sa.Integer(), nullable=False),
        sa.Column("created_by_user_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("archived_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("archived_by_user_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
    ...
    op.create_index(
        "ix_ai_sys_gov_preset_assign_diag_diff_reports_org_status",
        "ai_system_governance_preset_assignment_diagnostic_diff_reports",
        ["organization_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_preset_assign_diag_diff_reports_org_created",
        "ai_system_governance_preset_assignment_diagnostic_diff_reports",
        ["organization_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_preset_assign_diag_diff_reports_org_base",
        "ai_system_governance_preset_assignment_diagnostic_diff_reports",
        ["organization_id", "base_report_id"],
        unique=False,
    )
    op.create_index(
        "ix_ai_sys_gov_preset_assign_diag_diff_reports_org_compare",
        "ai_system_governance_preset_assignment_diagnostic_diff_reports",
