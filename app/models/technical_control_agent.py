...
class TechnicalControlAgent(UUIDPrimaryKeyMixin, OrganizationOwnedMixin, Base):
    __tablename__ = "technical_control_agents"
    __table_args__ = (
        Index("ix_technical_control_agents_token_hash", "token_hash"),
        Index(
