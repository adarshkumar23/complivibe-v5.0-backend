...
class AISystemRiskClassificationRecordSnapshot(UUIDPrimaryKeyMixin, TimestampMixin, OrganizationOwnedMixin, Base):
    __tablename__ = "ai_system_risk_classification_record_snapshots"
    __table_args__ = (
        Index(
    ...
    classification_id: Mapped[uuid.UUID] = mapped_column(
        Uuid,
        ForeignKey("ai_system_risk_classification_records.id", ondelete="CASCADE"),
        nullable=False,
    )
