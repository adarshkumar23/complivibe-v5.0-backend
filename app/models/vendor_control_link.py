...
class VendorControlLink(UUIDPrimaryKeyMixin, OrganizationOwnedMixin, Base):
    __tablename__ = "vendor_control_links"
    __table_args__ = (
        Index("ix_vendor_control_links_org_vendor", "organization_id", "vendor_id"),
        Index("ix_vendor_control_links_org_control", "organization_id", "control_id"),
        Index("ix_vendor_control_links_org_status", "organization_id", "status"),
        Index("ix_vendor_control_links_org_created", "organization_id", "created_at"),
    )
