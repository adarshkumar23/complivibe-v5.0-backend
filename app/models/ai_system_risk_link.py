...
class AISystemRiskLink(UUIDPrimaryKeyMixin, TimestampMixin, OrganizationOwnedMixin, Base):
    __tablename__ = "ai_system_risk_links"
    __table_args__ = (
        UniqueConstraint("organization_id", "ai_system_id", "risk_id", name="uq_ai_system_risk_link"),
        Index("ix_ai_system_risk_links_ai_system_id", "ai_system_id"),
        Index("ix_ai_system_risk_links_risk_id", "risk_id"),
        Index("ix_ai_system_risk_links_status", "status"),
    )
