...
PERMISSIONS: dict[str, str] = {
    ...
    "reports:share": "Mint externally-reachable tokenized share links for compliance reports",
    "carbon_accounting:read": "Read carbon accounting dashboards and summaries",
    "carbon_accounting:write": "Provision and rotate the carbon-accounting ingest API key",
    ...
    "ai_guardrail:read": "Read AI derived policy guardrails, check events, and signed receipt chains",
    ...
    "shadow_ai_signature:read": "Read signature-scored shadow-AI detections, signatures and federated candidates",
    "shadow_ai_signature:write": "Ingest shadow-AI telemetry and trigger signature rescans",
    "shadow_ai_signature:review": "Triage signature-scored shadow-AI detections (confirm, dismiss, escalate, suppress)",
    "shadow_ai_signature:admin": "Manage shadow-AI signature registry, IdP connections and federated promotion",
}
